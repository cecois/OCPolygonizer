...
<div id='map' style='width: 600px; height: 400px'></div>
		...
		var BaseballIcon = L.Icon.extend({
			...
			geojsonLayer.bindPopup(\"<html><head></head><body><form action='/mvc/index.php' method='get'><input type='hidden' name='urban_id' value='".$geojson['gid']."'><input type='hidden' name='hash' value='".$hash."'><input type='submit' value='load into geogeo'/></form></body></html>\");
